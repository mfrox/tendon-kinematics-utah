...
TEST(TendonHelpersTests, poly_at_empty) {
  Vec poly;
...
TEST(TendonHelpersTests, poly_at_constant) {
  Vec poly(1);
  poly << 3.2;
...
TEST(TendonHelpersTests, poly_at_linear) {
  Vec poly(2);
  poly << 1.2, 2.0;
...
TEST(TendonHelpersTests, poly_at_quadratic) {
  Vec poly(3);
  poly << 1.2, 2.0, 1.0;
...
TEST(TendonHelpersTests, poly_at_cubic) {
  Vec poly(4);
...
TEST(TendonHelpersTests, poly_at_many) {
  Vec poly(7);
...
TEST(TendonHelpersTests, poly_der_empty) {
  Vec poly;
  Vec expected_der;
...
TEST(TendonHelpersTests, poly_der_constant) {
  Vec poly(1);
  poly << 2.3;
  Vec expected_der(1);
  expected_der << 0;
...
TEST(TendonHelpersTests, poly_der_linear) {
  Vec poly(2);
  poly << 2.3, 1.3;
  Vec expected_der(2);
...
TEST(TendonHelpersTests, poly_der_quadratic) {
  Vec poly(3);
  poly << 2.3, 1.3, 0.25;
  Vec expected_der(3);
...
TEST(TendonHelpersTests, poly_der_cubic) {
  Vec poly(4);
...
TEST(TendonHelpersTests, poly_der_many) {
  Vec poly(10);
